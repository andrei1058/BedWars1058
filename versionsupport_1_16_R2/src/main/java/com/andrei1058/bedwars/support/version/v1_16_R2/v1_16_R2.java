...
public class v1_16_R2 extends VersionSupport {
    ...
    public List<Block> calculateExplosionBlocks(IArena arena, Entity source, Location explosionLocation, int radius, boolean fire, BiFunction<Location, Block, Boolean> callback) {
        ...
        net.minecraft.server.v1_16_R2.Entity sourceEntity = null;
        if (source != null) {
            sourceEntity = ((CraftEntity) source).getHandle();

        }

        net.minecraft.server.v1_16_R2.World world = ((CraftWorld) Objects.requireNonNull(bukkitWorld)).getHandle();

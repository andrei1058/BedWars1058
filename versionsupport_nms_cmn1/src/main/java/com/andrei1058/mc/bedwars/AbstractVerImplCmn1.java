package com.andrei1058.mc.bedwars;
...
import com.andrei1058.mc.bedwars.despawnable.DespawnableAttributes;
import com.andrei1058.mc.bedwars.despawnable.DespawnableFactory;
import com.andrei1058.mc.bedwars.despawnable.DespawnableType;
...
/**
 * Common NMS code for versions: 1.21.
 * This was introduced because nms package is now free of version code.
 */
public abstract class AbstractVerImplCmn1 extends VersionSupport {

    private final DespawnableFactory despawnableFactory;

    public AbstractVerImplCmn1(Plugin plugin, String name) {
        super(plugin, name);
        loadDefaultEffects();
    ...
    abstract public void registerCommand(String name, Command cmd);
    ...
    public abstract boolean isBukkitCommandRegistered(String name);
    ...
    public void hideArmor(@NotNull Player victim, Player receiver) {
        ...
        items.add(new Pair<>(EnumItemSlot.f, new ItemStack(net.minecraft.world.item.Item.b(0))));
        items.add(new Pair<>(EnumItemSlot.e, new ItemStack(net.minecraft.world.item.Item.b(0))));
        items.add(new Pair<>(EnumItemSlot.d, new ItemStack(net.minecraft.world.item.Item.b(0))));

...
import org.bukkit.craftbukkit.v1_21_R4.entity.CraftFireball;
...
public class v1_21_R4_NMS extends AbstractVerImplCmn1
{

    private ClientboundPlayerInfoUpdatePacket.a ADD_PLAYER_ACTION = null;

    public v1_21_R4_NMS(Plugin plugin, String name) {
        super(plugin, name);
    }

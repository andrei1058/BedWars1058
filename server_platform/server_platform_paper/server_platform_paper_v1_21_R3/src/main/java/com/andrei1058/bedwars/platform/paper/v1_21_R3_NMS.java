...
import org.bukkit.craftbukkit.v1_21_R3.entity.CraftFireball;
...
public class v1_21_R3_NMS extends AbstractVerImplCmn1
{

    private ClientboundPlayerInfoUpdatePacket.a ADD_PLAYER_ACTION = null;

    public v1_21_R3_NMS(Plugin plugin, String name) {
        super(plugin, name);
    }
    ...
    public void voidKill(Player p) {
        ...
        // out of world
        var damageSource = ((CraftWorld)p.getWorld()).getHandle().ak().m();

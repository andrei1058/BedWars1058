...
import com.andrei1058.bedwars.support.version.v1_12_R1.entities.IGolem;
import com.andrei1058.bedwars.support.version.v1_12_R1.entities.Silverfish;
...
public class v1_12_R1 extends VersionSupport {
    ...
    public void spawnSilverfish(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(com.andrei1058.bedwars.support.version.v1_12_R1.entities.Silverfish.spawn(loc, bedWarsTeam), bedWarsTeam, shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_SILVERFISH_DESPAWN), Messages.SHOP_UTILITY_NPC_SILVERFISH_NAME,

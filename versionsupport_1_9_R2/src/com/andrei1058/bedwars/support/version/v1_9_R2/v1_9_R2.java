...
public class v1_9_R2 extends VersionSupport {
    ...
    public void spawnSilverfish(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(com.andrei1058.bedwars.support.version.v1_9_R2.entities.Silverfish.spawn(loc, bedWarsTeam), bedWarsTeam, shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_SILVERFISH_DESPAWN),

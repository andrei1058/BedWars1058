...
public class v1_9_R2 extends VersionSupport {
    ...
    public List<org.bukkit.block.Block> calculateExplosionBlocks(IArena arena, Entity source, Location explosionLocation, int radius, boolean fire, BiFunction<Location, org.bukkit.block.Block, Boolean> callback) {
        ...
        net.minecraft.server.v1_9_R2.Entity sourceEntity = null;
        if (source != null) {
            sourceEntity = ((CraftEntity) source).getHandle();

        }

        net.minecraft.server.v1_9_R2.World world = ((CraftWorld) bukkitWorld).getHandle();
                ...
                for (j = 0; j < 16; ++j) {
                    if (k == 0 || k == 15 || i == 0 || i == 15 || j == 0 || j == 15) {
                        ...
                        for (double d6 = locZ; f > 0.0F; f -= 0.22500001F) {
                            ...
                            if (iblockdata.getMaterial() != net.minecraft.server.v1_9_R2.Material.AIR) {
                                ...
                                if (allow) {
                                    float f2 = sourceEntity != null ? sourceEntity.a(explosion, world, blockposition, iblockdata) : iblockdata.getBlock().a((net.minecraft.server.v1_9_R2.Entity) null);

...
public class IGolem extends EntityIronGolem {
    ...
    protected void u() {
        ...
        this.bQ.a(7, new PathfinderGoalNearestAttackableTarget(
                this, IGolem.class, 20, true, false,
                golem -> ((IGolem)golem).getTeam() != team)
        );
        this.bQ.a(8, new PathfinderGoalNearestAttackableTarget(

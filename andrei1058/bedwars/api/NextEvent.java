     ...
     public int getValue(Arena arena) {
          ...
          switch (super.name()){
               case "DIAMOND_GENERATOR_TIER_III":
                    if (!arena.getNextEvents().contains(NextEvent.valueOf("DIAMOND_GENERATOR_TIER_II")))
               ...
               case "EMERALD_GENERATOR_TIER_II":
                    if (!arena.getNextEvents().contains(NextEvent.valueOf("EMERALD_GENERATOR_TIER_III")))
                         value = arena.upgradeDiamondsCount;
                    break;
               case "EMERALD_GENERATOR_TIER_III":
                    if (!arena.getNextEvents().contains(NextEvent.valueOf("EMERALD_GENERATOR_TIER_II")))
                         value = arena.upgradeDiamondsCount;
                    break;
               case "BEDS_DESTROY":

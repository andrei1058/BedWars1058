...
public class v1_15_R1 extends VersionSupport {
    ...
    public List<Block> calculateExplosionBlocks(IArena arena, Entity source, Location explosionLocation, float radius, boolean fire, BiFunction<Location, Block, Boolean> callback) {
        ...
        net.minecraft.server.v1_15_R1.Entity sourceEntity = null;
        if (source != null) {
            sourceEntity = ((CraftEntity) source).getHandle();

        }

        net.minecraft.server.v1_15_R1.World world = ((CraftWorld) Objects.requireNonNull(bukkitWorld)).getHandle();

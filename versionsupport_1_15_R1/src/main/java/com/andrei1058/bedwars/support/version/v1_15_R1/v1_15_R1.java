...
public class v1_15_R1 extends VersionSupport {
    ...
    public void registerEntities() {
        ...
        /*EntityTypes.a<net.minecraft.server.com.andrei1058.bedwars.support.version.v1_15_R1.v1_15_R1.Entity> a =*/
    ...
    public static class VillagerShop extends EntityVillager {
        ...
        @Override
        public void a(ReputationEvent reputationevent, net.minecraft.server.v1_15_R1.Entity entity) {
        }
    ...
    public void hideArmor(Player p, Player p2) {
        PacketPlayOutEntityEquipment hand1 = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.MAINHAND, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment hand2 = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.OFFHAND, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment helmet = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.HEAD, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment chest = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.CHEST, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment pants = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.LEGS, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment boots = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.FEET, new ItemStack(net.minecraft.server.v1_15_R1.Item.getById(0)));

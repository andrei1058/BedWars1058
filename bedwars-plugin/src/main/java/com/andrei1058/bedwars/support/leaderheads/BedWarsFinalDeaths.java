...
public class BedWarsFinalDeaths extends OnlineDataCollector {
    ...
    public BedWarsFinalDeaths() {
        super("bw-final-deaths", BedWars.plugin.getName(), BoardType.DEFAULT, "&8BedWars Final Deaths", "openbwfinaldeaths", Arrays.asList(null, null, "&e{amount} final deaths", null));
    }

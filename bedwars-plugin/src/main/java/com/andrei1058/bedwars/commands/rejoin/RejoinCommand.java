...
public class RejoinCommand extends BukkitCommand {
    ...
    public boolean execute(CommandSender s, String st, String[] args) {
        ...
        if (rj == null) {
            p.sendMessage(SupportPAPI.getSupportPAPI().replace(p, Language.getMsg(p, Messages.REJOIN_NO_ARENA)));
        ...
        p.sendMessage(SupportPAPI.getSupportPAPI().replace(p, Language.getMsg(p, Messages.REJOIN_ALLOWED)).replace("{arena}", rj.getArena().getDisplayName()));

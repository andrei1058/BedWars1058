...
//                String prefixListPath = arena.getStatus() == GameState.playing ? Messages.FORMATTING_SCOREBOARD_TAB_PREFIX_PLAYING : Messages.FORMATTING_SCOREBOARD_TAB_PREFIX_RESTARTING;
//                String suffixListPath = arena.getStatus() == GameState.playing ? Messages.FORMATTING_SCOREBOARD_TAB_SUFFIX_PLAYING : Messages.FORMATTING_SCOREBOARD_TAB_SUFFIX_RESTARTING;
...
//                            return Language.getMsg(getPlayer(), Messages.FORMATTING_SCOREBOARD_TAB_PREFIX_SPECTATOR) + Language.getMsg(getPlayer(), Messages.FORMATTING_SPECTATOR_TEAM);
//                        }
...
//                        if (arena.isSpectator(player)) {
//                            return Language.getMsg(getPlayer(), Messages.FORMATTING_SCOREBOARD_TAB_PREFIX_SPECTATOR);
//                        }
//                        ITeam team = arena.getTeam(player);
//                        if (team == null) {
//                            team = arena.getExTeam(player.getUniqueId());

...
public class BoardManager implements IScoreboardService {
    ...
    private void registerPlaceholders(){
        ...
        pm.registerPlayerPlaceholder("%bw_v_prefix%",placeholderRefresh, player -> getChatSupport().getPrefix((Player) player.getPlayer()));
        pm.registerPlayerPlaceholder("%bw_v_suffix%", placeholderRefresh, player -> getChatSupport().getSuffix((Player) player.getPlayer()));
        ...
        pm.registerPlayerPlaceholder("%bw_money%", placeholderRefresh, player -> getEconomy().getMoney((Player) player.getPlayer()));
        ...
        pm.registerServerPlaceholder("%bw_server_id%", placeholderRefresh, () -> config.getString(ConfigPath.GENERAL_CONFIGURATION_BUNGEE_OPTION_SERVER_ID));

...
public class LevelsConfig extends ConfigManager {
    ...
    public static void init() {
        ...
        if (levels.isFirstTime()) {
            ...
            levels.getYml().addDefault("levels.3900-3999.name", "&d[{number}⚝] ");
            ...
            levels.getYml().addDefault("levels.4800-4899.rankup-cost", 5000);
            levels.getYml().addDefault("levels.4900-4999.name", "&b[{number}⚝] ");
            levels.getYml().addDefault("levels.4900-4999.rankup-cost", 5000);

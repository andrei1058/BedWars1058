...
public class UpgradesConfig extends ConfigManager {
    ...
    public UpgradesConfig(String name, String dir) {
        ...
        if (isFirstTime()) {
            ...
            yml.addDefault("upgrade-miner.tier-1.receive", Collections.singletonList("player-effect: FAST_DIGGING,1,0,team"));
            ...
            yml.addDefault("upgrade-miner.tier-2.receive", Collections.singletonList("player-effect: FAST_DIGGING,2,0,team"));

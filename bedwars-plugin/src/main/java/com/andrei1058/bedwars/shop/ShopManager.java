...
public class ShopManager extends ConfigManager {
    ...
    private void saveDefaults() {
        ...
        if (isFirstTime()) {
            ...
            getYml().addDefault(ConfigPath.SHOP_PATH_CATEGORY_POTIONS + ".category-content.jump-potion." + "tier1.tier-item.potion-display", "minecraft:leaping");
            ...
            adCategoryContentTier(ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "speed-potion", 19, "tier1",
                    BedWars.getForCurrentVersion("POTION", "POTION", "POTION"), 0, 1, false, 1, "emerald", false, false);
            getYml().addDefault(ConfigPath.SHOP_PATH_CATEGORY_POTIONS + ".category-content.speed-potion." + "tier1.tier-item.potion-display", "minecraft:swiftness");
            ...
            getYml().addDefault(ConfigPath.SHOP_PATH_CATEGORY_POTIONS + ".category-content.invisibility." + "tier1.tier-item.potion-display", "minecraft:invisibility");

...
public class ChineseSimplified extends Language {
    public ChineseSimplified() {
        ...
        yml.addDefault(Messages.COMMAND_MAIN, Arrays.asList("", "&2▪ &7/" + BedWars.mainCmd + " stats", "&2▪ &7/" + BedWars.mainCmd + " join &o<游戏/模式>", "&2▪ &7/" + BedWars.mainCmd + " leave", "&2▪ &7/" + BedWars.mainCmd + " lang", "&2▪ &7/" + BedWars.mainCmd + " gui", "&2▪ &7/" + BedWars.mainCmd + " start &3(vip)"));
        ...
        yml.addDefault("lobby-items-%path%-lore".replace("%path%", "stats"), Collections.singletonList("&f右键显示你的数据！"));
        yml.addDefault("lobby-items-%path%-name".replace("%path%", "arena-selector"), "&e选择游戏");
        ...
        yml.addDefault("pre-game-items-%path%-lore".replace("%path%", "stats"), Collections.singletonList("&f右键显示你的数据！"));
        yml.addDefault("pre-game-items-%path%-name".replace("%path%", "leave"), "&e返回大厅");
        yml.addDefault("pre-game-items-%path%-lore".replace("%path%", "leave"), Collections.singletonList("&右键离开游戏！"));
        ...
        yml.addDefault("scoreboard.3v3v3v3.playing", Arrays.asList("&e&l起床战争", "&7{date}", "", "&f{nextEvent} - &a{time}", "", "{team}", "{team}", "{team}", "{team}", "{team}", "{team}", "{team}", "{team}", "", "&f击杀： &a{kills}", "&f最终击杀： &a{finalKills}", "&f破坏床： &a{beds}", "", "&e{server_ip}"));
        ...
        yml.addDefault("shop-lore-status-cant-afford", "&c你没有足够的{currency}！");
        ...
        addContentMessages(yml, "wool", "blocks-category", "{color}羊毛", Arrays.asList("&7花费： &f{cost} {currency}", "", "&7很好的搭路工具", "&7购买后将变为你队伍的颜色", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "chainmail", "armor-category", "{color}锁链护甲", Arrays.asList("&7花费： {cost} {currency}", "", "&7锁链靴子和护腿", "&7死亡不掉落", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "iron-armor", "armor-category", "{color}铁护甲", Arrays.asList("&7花费： {cost} {currency}", "", "&7铁靴子和护腿", "&7死亡不掉落", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "diamond-armor", "armor-category", "{color}钻石护甲", Arrays.asList("&7花费： {cost} {currency}", "", "&7钻石靴子和护腿", "&7死亡不掉落", "", "{quick_buy}", "{buy_status}"));
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "dragon").replace("{tier}", "tier-1"), Arrays.asList("&7在绝杀时你的队伍会由2条而不是1条龙！", "", "&7花费： &b{cost} {currency}", ""));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "first", Arrays.asList("&7第一个进入你基地的敌人将触发该陷阱！"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "second", Arrays.asList("&7第二个进入你基地的敌人将触发该陷阱！"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE1_PATH + "third", Arrays.asList("&7第三个进入你基地的敌人将触发该陷阱！"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_CUSTOM_MSG + "3", "&c&l警报陷阱被{color}&l{team}的&7&l{player}&c&l触发了！");

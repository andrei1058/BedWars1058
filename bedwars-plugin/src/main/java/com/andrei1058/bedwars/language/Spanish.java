...
public class Spanish extends Language {
    ...
    public Spanish() {
        ...
        yml.addDefault(Messages.CHEST_INSERT_ITEM_ALLOWED, "&eSe agregó x{amount} {item} al {chest}");
        yml.addDefault(Messages.CHEST_INSERT_ITEM_DENIED, "&c¡Tu {chest} está lleno! No podemos agregar más elemento.");
        save();

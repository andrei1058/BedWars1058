...
public class Polish extends Language{
    ...
    public Polish() {
        ...
        yml.addDefault(Messages.XP_REWARD_BED_DESTROYED, "{prefix}&6+{xp} Otrzymano doswiedczenie BedWars (Bed Destroyed).");
        yml.addDefault(Messages.XP_REWARD_REGULAR_KILL, "{prefix}&6+{xp} Otrzymano doswiedczenie BedWars (Regular Kill).");
        yml.addDefault(Messages.XP_REWARD_FINAL_KILL, "{prefix}&6+{xp} Otrzymano doswiedczenie BedWars (Final Kill).");  

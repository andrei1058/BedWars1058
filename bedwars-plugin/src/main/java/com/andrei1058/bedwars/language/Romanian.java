...
public class Romanian extends Language {
    ...
    public Romanian() {
        ...
        yml.addDefault(Messages.CHEST_INSERT_ITEM_ALLOWED, "&eAdăugat x{quantity} {item} la {chest}");
        yml.addDefault(Messages.CHEST_INSERT_ITEM_DENIED, "&cTa {chest} este plin ! Nu putem adăuga mai multe elemente.");
        save();

...
public class Persian extends Language {
    ...
    public Persian() {
        ...
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_IN_VOID_REGULAR_KILL, "{PlayerColor}{PlayerName} &7tavasote {KillerColor}{KillerName} &7part shod dakhel void.");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_IN_VOID_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasote {KillerColor}{KillerName} &7dakhel void part shod. &b&lFINAL KILL!");

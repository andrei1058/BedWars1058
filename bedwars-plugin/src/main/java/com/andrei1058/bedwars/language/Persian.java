...
public class Persian extends Language {
    ...
    public Persian() {
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CHAT, "{prefix}&eBazi dar &6{time} &esanie dige shoroo mishe!");
        ...
        yml.addDefault(Messages.INTERACT_CANNOT_BREAK_BLOCK, "{prefix}&cShoma faghat block haei ke player ha gozashtan ro mitoonid bekanid!");
        yml.addDefault(Messages.INTERACT_CANNOT_BREAK_OWN_BED, "&cShoma nemitoonid bed khodetoon ro bekanid!");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_CHAT_ANNOUNCEMENT, "\n&f&lBED AZ BEIN RAFT > {TeamColor}{TeamName} Bed &7tavasot {PlayerColor}{PlayerName} &7az bein raft!\n");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&cBED AZ BEIN RAFT!");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_SUBTITLE_ANNOUNCEMENT, "&fShoma digar respawn nemishavid!");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_CHAT_ANNOUNCEMENT_TO_VICTIM, "&f&lBED AZ BEIN RAFT > &7Bed shoma tavasot {PlayerColor}{PlayerName} &7az bein raft!");
        yml.addDefault(Messages.INTERACT_CHEST_CANT_OPEN_TEAM_ELIMINATED, "&cShoma nemitoonid in chest ro baz konid bedalil inke teame saheb hanooz zendan!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_IN_VOID_REGULAR_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7part shod dakhel void.");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_IN_VOID_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7dakhel void part shod. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_REGULAR, "{PlayerColor}{PlayerName} &7hengam mobareze ba {KillerColor}{KillerName} &7az server kharej shod.");
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_FINAL, "{PlayerColor}{PlayerName} &7hengam mobareze ba {KillerColor}{KillerName} &7az server kharej shod. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_REGULAR_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7part shod.");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7part shod. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITH_SOURCE_REGULAR_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7bar asar enfejar mord.");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITH_SOURCE_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7bar asar enfejar mord. &b&lFINAL KILL!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_PVP_REGULAR_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7koshte shod.");
        yml.addDefault(Messages.PLAYER_DIE_PVP_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7koshte shod. &b&lFINAL KILL!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_SHOOT_REGULAR, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7shoot shod!");
        yml.addDefault(Messages.PLAYER_DIE_SHOOT_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot {KillerColor}{KillerName} &7shoot shod! &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_DEBUG_REGULAR, "{PlayerColor}{PlayerName} &7tavasot BedBug {KillerColor}{KillerTeamName} &7koshte shod!");
        yml.addDefault(Messages.PLAYER_DIE_DEBUG_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot BedBug {KillerColor}{KillerTeamName} &7koshte shod! &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_IRON_GOLEM_REGULAR, "{PlayerColor}{PlayerName} &7tavasot Iron Golem {KillerColor}{KillerTeamName} koshte shod!");
        yml.addDefault(Messages.PLAYER_DIE_IRON_GOLEM_FINAL_KILL, "{PlayerColor}{PlayerName} &7tavasot Iron Golem {KillerColor}{KillerTeamName} &7koshte shod! &b&lFINAL KILL!");
        ...
        addDefaultStatsMsg(yml, "final-kills", "&6Kill Payani", "&f{finalKills}");
        addDefaultStatsMsg(yml, "final-deaths", "&6Death Payani", "&f{finalDeaths}");
        addDefaultStatsMsg(yml, "beds-destroyed", "&6Bed haye Kande Shode", "&f{bedsDestroyed}");
        addDefaultStatsMsg(yml, "first-play", "&6Avalin Bazi", "&f{firstPlay}");
        addDefaultStatsMsg(yml, "last-play", "&6Akharin Bazi", "&f{lastPlay}");
        addDefaultStatsMsg(yml, "games-played", "&6Tedad Bazi", "&f{gamesPlayed}");
        ...
        yml.addDefault(Messages.UPGRADES_BASE_TRAP_ITEM_LORE_PATH + "3", Arrays.asList("&7Hengam vorood afrad invisible", "&7hoshdar dade mishe.", ""));
        yml.addDefault(Messages.UPGRADES_BASE_TRAP_ITEM_NAME_PATH + "4", "{color}Trap Miner Fatigue");
        yml.addDefault(Messages.UPGRADES_BASE_TRAP_ITEM_LORE_PATH + "4", Arrays.asList("&7Baraye 10 sanie Miner Fatigue enemy", "&7haei ke vared shodan ro faal mikone.", ""));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_QUEUE_LIMIT, "&cEmkan kharid tale bishtar nist!");
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_CUSTOM_MSG + "3", "&c&lHoshdar tale tavasot &7&l{player} &c&laz team {color}&l{team} &c&lkhamoosh shod!");
        yml.addDefault(Messages.UPGRADES_TRAP_CUSTOM_TITLE + "3", "&c&lHOSHDAR!!!");
        yml.addDefault(Messages.UPGRADES_TRAP_CUSTOM_SUBTITLE + "3", "&fAlarm tale tavasot team {color}{team} &fkhamoosh shod!");
        save();

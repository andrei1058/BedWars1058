...
public class SimplifiedChinese extends Language {
    ...
    public SimplifiedChinese() {
        ...
        yml.addDefault(Messages.COMMAND_LEAVE_MSG, "{prefix}&7{player}&e离开了游戏！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_SENT_TARGET_RECEIVE_MSG, "{prefix}&b{player}&e邀请你加入组队！ &o&7(点此接受)");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_CANNOT_INVITE_YOURSELF, "{prefix}&c你不可以邀请你自己！");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player}&e不在线！");
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_DENIED_NO_INVITE, "{prefix}&c没有可以接受的组队邀请！");
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_DENIED_ALREADY_IN_PARTY, "{prefix}&e你已经在组队中了！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_SUCCESS, "{prefix}&7{player}&e加入了组队！");
        yml.addDefault(Messages.COMMAND_PARTY_GENERAL_DENIED_NOT_IN_PARTY, "{prefix}&c你不在组队中！");
        yml.addDefault(Messages.COMMAND_PARTY_LEAVE_DENIED_IS_OWNER_NEEDS_DISBAND, "{prefix}&c你不可以离开由你带领的组队！\n&e使用：&b/party disband &e来解散组队。");
        yml.addDefault(Messages.COMMAND_PARTY_LEAVE_SUCCESS, "{prefix}&7{player}&e离开了组队！");
        yml.addDefault(Messages.COMMAND_PARTY_DISBAND_SUCCESS, "{prefix}&e组队已解散！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_INFO_PLAYERS,"{prefix}&e成员：");
        ...
        yml.addDefault(Messages.ARENA_GUI_ARENA_CONTENT_LORE, Arrays.asList("", "&7状态：{status}", "&7玩家数：&f{on}&7/&f{max}", "&7模式：&a{group}", "", "&a点击进入", "&e右击观战"));
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CHAT, "{prefix}&e游戏将在&6{time}&e秒后开始！");
        ...
        yml.addDefault(Messages.GENERATOR_HOLOGRAM_TIMER, "&c{seconds}&e秒后生成");
        ...
        yml.addDefault(Messages.FORMATTING_CHAT_SHOUT, "{level}{vPrefix}&6[喊话] {team} &7{player}&f{vSuffix}：{message}");
        ...
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_SUBTITLE, "&e你将在&c{time}&e秒后重生！");
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_CHAT, "{prefix}&e你将在&c{time}&e秒后重生！");
        ...
        yml.addDefault(Messages.MONEY_REWARD_PER_MINUTE, "{prefix}&6+{money}硬币(游戏时间)");
        yml.addDefault(Messages.MONEY_REWARD_WIN, "{prefix}&6+{money}硬币(游戏胜利)");
        yml.addDefault(Messages.MONEY_REWARD_PER_TEAMMATE, "{prefix}&6+{money}硬币(团队协作)");
        yml.addDefault(Messages.MONEY_REWARD_BED_DESTROYED, "{prefix}&6+{money}硬币(破坏床)");
        yml.addDefault(Messages.MONEY_REWARD_FINAL_KILL, "{prefix}&6+{money}硬币(最终击杀)");
        yml.addDefault(Messages.MONEY_REWARD_REGULAR_KILL, "{prefix}&6+{money}硬币(击杀)");
        ...
        yml.addDefault(Messages.SCOREBOARD_DEFAULT_RESTARTING_SPEC, Arrays.asList(
                "&f&l起床战争,&f&l起床战争,&f&l起床战争,&f&l起床战争,&f&l起床战争,&f&l起床战争,&f&l起床战争,&f&l{poweredBy},&f&l{poweredBy},&f&l{poweredBy},&e&l起床战争,&e&l起床战争,&e&l起床战争,&e&l起床战争,&e&l起床战争,&e&l起床战争,&e&l起床战争,&e&l{poweredBy},&e&l{poweredBy},&e&l{poweredBy}",
                "&7{date}",
                "",
                "&6胜者： {winnerTeamColor}{winnerTeamName} &6⭐",
                "",
                "&7&l击杀数排行：",
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN1_HEADER, List.of(
                "                                                                                                        ",
                "&6⭐ {winnerTeamColor}&l你的队伍在这场游戏中获得胜利！ &6⭐",
                "&7{date}", "&7地图：&f{map} &7模式：&f{group}",
                ""
        ));
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN1_FOOTER, List.of(
                "",
                "&6&l你在{teamColor}&l{teamName}&6&l中获得胜利！,&6&l你在{teamColor}&l{teamName}&6&l中获得胜利！,&f&l你在{teamColor}&l{teamName}&f&l中获得胜利！",
                "&7你在这场游戏中的战绩",
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN2_HEADER, List.of(
                "                                                                                                        ",
                "&6⭐ {winnerTeamColor}&l{winnerTeamName}在这场游戏中获得胜利！ &6⭐",
                "&7{date}",
                "&7地图：&f{map} &7模式：&f{group}",
                ""
        ));
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN2_FOOTER, List.of(
                "",
                "&6&l你在{teamColor}&l{teamName}&6&l中获得胜利！,&6&l你在{teamColor}&l{teamName}&6&l中获得胜利！,&f&l你在{teamColor}&l{teamName}&6&l中获得胜利！",
                "&7你在这场游戏中的战绩",
                "&e击杀：&f{kills} &8| &e最终击杀：&f{finalKills} &8| &e破坏床：&f{beds} &8| &e死亡：&f{deaths},&e击杀：&7{kills} &8| &e最终击杀：&7{finalKills} &8| &e破坏床：&7{beds} &8| &e死亡：&7{deaths}",
                "",
                "&f感谢游玩，{player}!",
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_ELM_HEADER, List.of(
                "                                                                                                        ",
                "&6⭐ {winnerTeamColor}&l{winnerTeamName}&6在这场游戏中获得胜利！ &6⭐",
                "&7{date}",
                "&7地图：&f{map} &7模式：&f{group}",
                ""
        ));
        ...
        yml.addDefault(Messages.SHOP_INSUFFICIENT_MONEY, "{prefix}&c你没有足够的{currency}！ 还需要{currency}x{amount}！");
        yml.addDefault(Messages.SHOP_NEW_PURCHASE, "{prefix}&a你购买了&6{item}");
        ...
        addContentMessages(yml, "stick", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "{color}木棍(击退I)", Arrays.asList("&7花费：{cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "speed-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}速度II药水（45 秒）", Arrays.asList("&7花费：{cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "jump-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}跳跃提升V药水（45 秒）", Arrays.asList("&7花费：{cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "dream-defender", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}梦境守卫者", Arrays.asList("&7花费：{cost} {currency}", "",
                "&7召唤铁傀儡来保护基地", "&7持续4分钟", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "Compact Pop-up Tower", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}速建防御塔", Arrays.asList("&花费: {cost} {currency}", "",
                "&7放置一个速建防御塔", "&7塔防！", "", "{quick_buy}", "{buy_status}"));
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "dragon").replace("{tier}", "tier-1"), "{color}龙增益");
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_CUSTOM_MSG + "3", "{color}&l{team}&7&l{player}&c&l触发了报警陷阱！");

...
public class BedWars extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        if (JavaVersion.contains("1.8")) {
            Bukkit.getLogger().info("Your Java Version is " + JavaVersion + " This plugin requires Java 11 or higher");
            Bukkit.getPluginManager().disablePlugin(this);
            return;
        }

        double versionD = Double.parseDouble(JavaVersion.substring(0, 2));

        if (versionD < 11) {
            Bukkit.getLogger().info("Your Java Version is " + JavaVersion + " This plugin requires Java 11 or higher");
            Bukkit.getPluginManager().disablePlugin(this);
            return;
        } else if (versionD >= 11  && versionD < 17) {
            Bukkit.getLogger().info("Your Java Version is " + JavaVersion + " This plugin is compatible with your version but we suggest you update to Java 17 or higher");
        }else if (versionD >= 17) {
            Bukkit.getLogger().info("Your Java Version is " + JavaVersion + " This plugin is compatible with your version");
        }

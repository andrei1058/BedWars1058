...
public class Silverfish extends EntitySilverfish {
    ...
    protected Silverfish(World world, BedWarsTeam bedWarsTeam) {
        super(world);
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(GenericAttributes.maxHealth).setValue(Main.shop.getYml().getDouble(ConfigPath.SHOP_SPECIAL_SILVERFISH_HEALTH));
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(Main.shop.getYml().getDouble(ConfigPath.SHOP_SPECIAL_SILVERFISH_SPEED));
        this.getAttributeInstance(GenericAttributes.ATTACK_DAMAGE).setValue(Main.shop.getYml().getDouble(ConfigPath.SHOP_SPECIAL_SILVERFISH_DAMAGE));
    }

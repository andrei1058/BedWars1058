package com.andrei1058.bedwars.support.version.v1_13_R1;
...
import com.andrei1058.bedwars.support.version.v1_13_R1.entities.IGolem;
import com.andrei1058.bedwars.support.version.v1_13_R1.entities.Silverfish;
...
public class v1_13_R1 extends VersionSupport {
    ...
    public void registerCommand(String name, Command clasa) {
        ((CraftServer) Main.plugin.getServer()).getCommandMap().register(name, clasa);
    }
    ...
    public void spawnSilverfish(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(Silverfish.spawn(loc, bedWarsTeam), bedWarsTeam, Main.shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_SILVERFISH_DESPAWN), Messages.SHOP_UTILITY_NPC_SILVERFISH_NAME,
    ...
    public void spawnIronGolem(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(IGolem.spawn(loc, bedWarsTeam), bedWarsTeam, Main.shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_IRON_GOLEM_DESPAWN), Messages.SHOP_UTILITY_NPC_IRON_GOLEM_NAME,
    ...
    public boolean isBukkitCommandRegistered(String name) {
        return ((CraftServer) Main.plugin.getServer()).getCommandMap().getCommand(name) != null;
    }
    ...
    public void registerEntities() {
        ...
        EntityTypes.a("bwsilverfish", EntityTypes.a.a(com.andrei1058.bedwars.support.version.v1_13_R1.entities.Silverfish.class, Silverfish::new));
    ...
    public void spawnDragon(Location l, BedWarsTeam bwt) {
        ...
        ed.setMetadata("DragonTeam", new FixedMetadataValue(Main.plugin, bwt));
    }
    ...
    public void registerTntWhitelist() {
        try {
            Field field = net.minecraft.server.v1_13_R1.Block.class.getDeclaredField("durability");

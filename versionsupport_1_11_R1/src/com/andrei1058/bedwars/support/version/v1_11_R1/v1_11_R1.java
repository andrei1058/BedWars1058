...
import com.andrei1058.bedwars.support.version.v1_11_R1.entities.IGolem;
import com.andrei1058.bedwars.support.version.v1_11_R1.entities.Silverfish;
...
public class v1_11_R1 extends VersionSupport {
    ...
    public void spawnSilverfish(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(com.andrei1058.bedwars.support.version.v1_11_R1.entities.Silverfish.spawn(loc, bedWarsTeam), bedWarsTeam, shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_SILVERFISH_DESPAWN), Messages.SHOP_UTILITY_NPC_SILVERFISH_NAME,
    ...
    public void hidePlayer(Player victim, Player p) {
        if (victim == p) return;
        net.minecraft.server.v1_11_R1.PacketPlayOutEntityDestroy packet = new net.minecraft.server.v1_11_R1.PacketPlayOutEntityDestroy(victim.getEntityId());
    ...
    public void hideArmor(Player p, Player p2) {
        PacketPlayOutEntityEquipment hand1 = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.MAINHAND, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment hand2 = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.OFFHAND, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment helmet = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.HEAD, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment chest = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.CHEST, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment pants = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.LEGS, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));
        PacketPlayOutEntityEquipment boots = new PacketPlayOutEntityEquipment(p.getEntityId(), EnumItemSlot.FEET, new ItemStack(net.minecraft.server.v1_11_R1.Item.getById(0)));

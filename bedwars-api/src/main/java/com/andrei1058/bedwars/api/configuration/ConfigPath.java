...
public class ConfigPath {
    ...
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_RADIUS = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".radius";
    ...
    public static final String GENERAL_FIREBALL_DESTORY_BLOCK_DESTORY_ORIGINAL_BLOCKS = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".destory-original-blocks";

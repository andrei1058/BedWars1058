...
public class ConfigPath {
    ...
    public static final String GENERAL_EXPLOSION_PATH = "explosion-settings";
    public static final String GENERAL_EXPLOSION_SIZE = GENERAL_EXPLOSION_PATH + ".explosion-size";

...
public class v1_19_R1 extends VersionSupport {
    ...
    public boolean isProjectile(org.bukkit.inventory.ItemStack itemStack) {
        ...
        return CraftItemStack.asNMSCopy(itemStack).G() instanceof IProjectile;
    }
    ...
    public double getDamage(org.bukkit.inventory.ItemStack i) {
        ...
        NBTTagCompound compound = (nmsStack.u() != null) ? nmsStack.u() : new NBTTagCompound();
...
//        head.setItemMeta(headMeta);
    ...
    public String getMainLevel() {
        ...
        return ((DedicatedServer) MinecraftServer.getServer()).u.a().m;
    }

...
package com.andrei1058.bedwars.support.version.v1_19_R1;
...
public class Silverfish extends EntitySilverfish {
    ...
    protected void u() {
        ...
        this.bS.a(2, new PathfinderGoalMeleeAttack(this, 1.9D, false));
        this.bT.a(1, new PathfinderGoalHurtByTarget(this));
        this.bS.a(3, new PathfinderGoalRandomStroll(this, 2D));
        this.bT.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityHuman.class, 20, true, false, player -> {
        ...
        this.bT.a(3, new PathfinderGoalNearestAttackableTarget(this, IGolem.class, 20, true, false, golem -> {
            return ((IGolem) golem).getTeam() != team;
        }));
        this.bT.a(4, new PathfinderGoalNearestAttackableTarget(this, Silverfish.class, 20, true, false, sf -> {
    ...
    public static LivingEntity spawn(Location loc, ITeam team, double speed, double health, int despawn, double damage) {
        ...
        Silverfish customEnt = new Silverfish(EntityTypes.aD, mcWorld, team);

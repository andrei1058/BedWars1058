...
public class IGolem extends EntityIronGolem {
    ...
    protected void u() {
        ...
        this.bS.a(2, new PathfinderGoalMeleeAttack(this, 1.5D, false));
        this.bT.a(3, new PathfinderGoalHurtByTarget(this));
        this.bS.a(4, new PathfinderGoalRandomStroll(this, 1D));
        this.bS.a(5, new PathfinderGoalRandomLookaround(this));
        this.bT.a(6, new PathfinderGoalNearestAttackableTarget(
        ...
        this.bT.a(7, new PathfinderGoalNearestAttackableTarget(
                this, IGolem.class, 20, true, false,
                golem -> ((IGolem)golem).getTeam() != team)
        );
        this.bT.a(8, new PathfinderGoalNearestAttackableTarget(
    ...
    public static LivingEntity spawn(Location loc, ITeam bedWarsTeam, double speed, double health, int despawn) {
        ...
        IGolem customEnt = new IGolem(EntityTypes.S, mcWorld, bedWarsTeam);

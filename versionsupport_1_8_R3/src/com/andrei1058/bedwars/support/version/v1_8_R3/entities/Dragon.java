...
public class Dragon extends EntityInsentient implements IComplex, IMonster {
    ...
    private double b;
    private double c;
    private double[][] bk = new double[64][3];
    private int bl = -1;
    private EntityComplexPart[] children;
    private EntityComplexPart bn;
    private EntityComplexPart bo;
    private EntityComplexPart bp;
    private EntityComplexPart bq;
    private EntityComplexPart br;
    private EntityComplexPart bs;
    private EntityComplexPart bt;
    private float bu;
    private float bv;
    private boolean bw;
    private boolean bx;
    ...
    private int by;
    private EntityEnderCrystal bz;
    private Explosion explosionSource = new Explosion(null, this, Double.NaN, Double.NaN, Double.NaN, (float) (Double.NaN), true, true);
    ...
    private void cf() {
        if (bedWarsTeam.getArena().getStatus() == GameState.restarting) target = null;
        this.bw = false;
        ArrayList arraylist = Lists.newArrayList(bedWarsTeam.getArena().getPlayers());
        Iterator iterator = arraylist.iterator();

        while (iterator.hasNext()) {
            Player p = (Player) iterator.next();
            if (bedWarsTeam.getMembers().contains(p)) {
                iterator.remove();
            } else if (bedWarsTeam.getArena().getRespawn().containsKey(p)) {
                iterator.remove();
            }
        }
    ...
    private boolean b(AxisAlignedBB axisalignedbb) {
        ...
        boolean flag = false;
        boolean flag1 = false;
        ArrayList<org.bukkit.block.Block> destroyedBlocks = new ArrayList<>();
        ...
        if (flag1) {
            ...
            Iterator<org.bukkit.block.Block> var30;
    ...
    private boolean dealDamage(DamageSource damagesource, float f) {
        ...
        if (!this.dead) {
            ...
            if (!this.world.isClientSide) {
                ...
                if (this.by == 1) {
                    ...
                    Iterator<EntityPlayer> var5 = MinecraftServer.getServer().getPlayerList().players.iterator();
    ...
    private void a(BlockPosition blockposition) {
        ...
        this.world.getServer().getPluginManager().callEvent(event);
        Iterator<org.bukkit.block.BlockState> var9;

...
import com.andrei1058.bedwars.support.version.v1_8_R3.entities.Dragon;
import com.andrei1058.bedwars.support.version.v1_8_R3.entities.IGolem;
import com.andrei1058.bedwars.support.version.v1_8_R3.entities.Silverfish;
...
public class v1_8_R3 extends VersionSupport {
    ...
    public void spawnSilverfish(Location loc, BedWarsTeam bedWarsTeam) {
        new Despawnable(com.andrei1058.bedwars.support.version.v1_8_R3.entities.Silverfish.spawn(loc, bedWarsTeam), bedWarsTeam, shop.getYml().getInt(ConfigPath.SHOP_SPECIAL_SILVERFISH_DESPAWN),
